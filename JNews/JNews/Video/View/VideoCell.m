...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        lengthLabel.textColor = COLOR(@"#ffffff");
...
-(void)setVideodataframe:(VideoFrameData *)videodataframe
{
    _videodataframe = videodataframe;
    VideoData *videodata = videodataframe.videodata;
